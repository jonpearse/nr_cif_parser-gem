...
class TestLiRecord < Minitest::Test

  # SETUP

  def arb_parse( msg )

    NrCifParser::Record::IntermediateLocation.parse( msg )

  end

  def record

    arb_parse( 'LICROY              1720 000000001                      1H  ' )
  ...
  def test_scheduled_arrival
    ...
    assert_equal "12:00:00", arb_parse( 'LICROY    1200      1720 000000001                      1H  ' ).schedule_arrival
    assert_equal "12:00:30", arb_parse( 'LICROY    1200H     1720 000000001                      1H  ' ).schedule_arrival
  ...
  def test_scheduled_departure
    ...
    assert_equal "12:00:30", arb_parse( 'LICROY         1200H1720 000000001                      1H  ' ).schedule_depart
  ...
  def test_scheduled_pass
    ...
    assert_equal "17:20:30", arb_parse( 'LICROY              1720H000000001                      1H  ' ).schedule_pass
  ...
  def test_public_arrival
    ...
    assert_equal "17:20:00", arb_parse( 'LICROY              1720 172000001                      1H  ' ).public_arrival
  ...
  def test_public_departure
    ...
    assert_equal "17:20:00", arb_parse( 'LICROY              1720 000017201                      1H  ' ).public_depart
  ...
  def test_platform
    ...
    assert_nil arb_parse( 'LICROY              1720 00000000                       1H  ' ).platform
  ...
  def test_line
    ...
    assert_equal "UMF", arb_parse( 'LICROY              1720 00000000   UMF                 1H  ' ).line
  ...
  def test_path
    ...
    assert_equal "UMF", arb_parse( 'LICROY              1720 00000000      UMF              1H  ' ).path
  ...
  def test_activity
    ...
    assert_equal [ 'X', '-U' ], arb_parse( 'LICROY              1720 00000000         X -U          1H  ' ).activity
  ...
  def test_eng_allowance
    ...
    assert_equal 91, arb_parse( 'LICROY              1720 000000001                    911H  ' ).eng_allowance
    assert_equal 9.5, arb_parse( 'LICROY              1720 000000001                    9H1H  ' ).eng_allowance
  ...
  def test_perf_allowance
    ...
    assert_equal 91, arb_parse( 'LICROY              1720 000000001                      1H91' ).perf_allowance
    assert_equal 9.5, arb_parse( 'LICROY              1720 000000001                      1H9H' ).perf_allowance
